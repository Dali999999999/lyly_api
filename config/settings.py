...
print(f"DEBUG: CORS_ALLOWED_ORIGINS={os.getenv('CORS_ALLOWED_ORIGINS', '').split(',')}")
print(f"DEBUG: CSRF_TRUSTED_ORIGINS={os.getenv('CSRF_TRUSTED_ORIGINS', '').split(',')}")
print("="*30)
...
DEFAULT_FROM_EMAIL = 'Lylys Bakery <noreply@lylysbakery.com>'
